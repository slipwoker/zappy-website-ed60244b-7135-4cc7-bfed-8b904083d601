    ...
    if (contactForm) {
        ...
        function validateField(input) {
            ...
            if (input.hasAttribute('required') && !value) {
                const fieldName = input.getAttribute('data-name') || name.replace(/[-_]/g, ' ') || 'This field';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'ed60244b-7135-4cc7-bfed-8b904083d601',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'ed60244b-7135-4cc7-bfed-8b904083d601';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'ed60244b-7135-4cc7-bfed-8b904083d601';
